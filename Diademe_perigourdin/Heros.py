...
class Heros:
    ...
    # def diademe(self, monstre_du_combat):
    #     if "diademe" in self.inventaire_hero:
    #         monstre_du_combat.pt_vies_monstre /= 2
...
hero1 = Heros("Fred le borgne", 120, 18)
hero2 = Heros("Max l'ami des plantes", 130, 17)
hero3 = Heros("Will corps de crevette", 100, 20)
